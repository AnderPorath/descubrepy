...
const DEFAULT_CATEGORIES: Array<{ id: number; slug: string; title: string; description: string | null; icon_name: string; business_count: number }> = [
  { id: 1, slug: "gastronomia", title: "Gastronomia", description: null, icon_name: "UtensilsCrossed", business_count: 45 },
  { id: 2, slug: "belleza-y-spa", title: "Belleza y Spa", description: null, icon_name: "Scissors", business_count: 32 },
  { id: 3, slug: "fitness", title: "Fitness", description: null, icon_name: "Dumbbell", business_count: 18 },
  { id: 4, slug: "cafeterias", title: "Cafeterias", description: null, icon_name: "Coffee", business_count: 27 },
  { id: 5, slug: "salud", title: "Salud", description: null, icon_name: "Stethoscope", business_count: 38 },
  { id: 6, slug: "automotriz", title: "Automotriz", description: null, icon_name: "Wrench", business_count: 15 },
  { id: 7, slug: "moda", title: "Moda", description: null, icon_name: "ShoppingBag", business_count: 52 },
  { id: 8, slug: "hoteleria", title: "Hoteleria", description: null, icon_name: "Building2", business_count: 12 },
  { id: 9, slug: "educacion", title: "Educacion", description: null, icon_name: "GraduationCap", business_count: 20 },
  { id: 10, slug: "transporte", title: "Transporte", description: null, icon_name: "Car", business_count: 10 },
  { id: 11, slug: "servicios", title: "Servicios", description: null, icon_name: "Briefcase", business_count: 35 },
  { id: 12, slug: "bienestar", title: "Bienestar", description: null, icon_name: "Heart", business_count: 22 },
  { id: 13, slug: "mascotas", title: "Mascotas", description: null, icon_name: "Dog", business_count: 14 },
  { id: 14, slug: "legal", title: "Legal", description: null, icon_name: "Scale", business_count: 8 },
  { id: 15, slug: "inmobiliarias", title: "Inmobiliarias", description: null, icon_name: "Home", business_count: 25 },
  { id: 16, slug: "farmacias", title: "Farmacias", description: null, icon_name: "Pill", business_count: 42 },
  { id: 17, slug: "supermercados", title: "Supermercados", description: null, icon_name: "ShoppingCart", business_count: 28 },
  { id: 18, slug: "fotografia", title: "Fotografia", description: null, icon_name: "Camera", business_count: 11 },
  { id: 19, slug: "eventos", title: "Eventos", description: null, icon_name: "Calendar", business_count: 19 },
  { id: 20, slug: "tecnologia", title: "Tecnologia", description: null, icon_name: "Smartphone", business_count: 16 },
]
